...
*/
       ...
       /*todo     var size = context.MeasureString(this.GameBoard.GameModel.NumberOfCoins.ToString());
       ...
       */     context.Restore();
        ...
        private void renderPullBox(ILayer context)
        {
         ...
         /*todo   var size = context.MeasureString(this.GameBoard.GameModel.NumberOfPulls.ToString());
