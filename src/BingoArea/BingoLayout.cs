...
namespace BingoBlockParty.Client.BingoGame
{
    public class BingoLayout : ILayoutView
    {
        ...
        public void SetState(BingoLayoutState state)
        {
            ...
            {
                case BingoLayoutState.PurchaseCards:
                    touchRectangles.Add(TouchManager.PushClickRect(new TouchRect(LightBoardPosition.X + PurchaseBingoCardPosition1.X, LightBoardPosition.Y + PurchaseBingoCardPosition1.Y, PurchaseBingoCardOutline.Width, PurchaseBingoCardOutline.Height, purchaseCard, state:1)));
                    touchRectangles.Add(TouchManager.PushClickRect(new TouchRect(LightBoardPosition.X + PurchaseBingoCardPosition2.X, LightBoardPosition.Y + PurchaseBingoCardPosition2.Y, PurchaseBingoCardOutline.Width, PurchaseBingoCardOutline.Height, purchaseCard,state:2)));
                    touchRectangles.Add(TouchManager.PushClickRect(new TouchRect(LightBoardPosition.X + PurchaseBingoCardPosition3.X, LightBoardPosition.Y + PurchaseBingoCardPosition3.Y, PurchaseBingoCardOutline.Width, PurchaseBingoCardOutline.Height, purchaseCard,state:3)));
                    touchRectangles.Add(TouchManager.PushClickRect(new TouchRect(LightBoardPosition.X + PurchaseBingoCardPosition4.X, LightBoardPosition.Y + PurchaseBingoCardPosition4.Y, PurchaseBingoCardOutline.Width, PurchaseBingoCardOutline.Height, purchaseCard, state: 4)));
                    break;
                case BingoLayoutState.InGame:
                    break;
                case BingoLayoutState.Lobby:
